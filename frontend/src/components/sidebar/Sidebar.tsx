...
export default function Sidebar({ toggled, toggleSidebar }: SidebarProps) {
  ...
  const { isAssistantGenerating, setActiveChatId, setActiveChatMessages, setChatIdUrlParam } = useContext(ChatContext) as ChatContextType;
      ...
      <div> {/* Top section */}
        <div> {/* Information */}
          ...
          <p className="text-sm">Your intelligent <b>Quranic</b> assistant</p>
            <button disabled={isAssistantGenerating} onClick={handleNewChatClick} className="button flex justify-center items-center gap-2 mt-3 !w-full">
